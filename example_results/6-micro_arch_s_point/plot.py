...
def read_data(engines, dir, inst_sample_length, cs_sample_length,
    ...
    for e in engines:
        fname_cycles = os.path.join(dir, e + '_s_inst_cycle')
        fname_cahce = os.path.join(dir, e + '_s_cache')
        fname_llc = os.path.join(dir, e + '_s_LLC')
        fname_dtlb = os.path.join(dir, e + '_s_DTLB')
        fname_itlb = os.path.join(dir, e + '_s_ITLB')
        fname_branch = os.path.join(dir, e + '_s_branch')
        fname_cs = os.path.join(dir, e + '_s_cs')
        ...
        fname_fio_1 = os.path.join(dir, e + '_s.txt')
        ...
        all_cs_per_io.append(cs_per_sec / iops_1)
        all_cs_per_io_std.append(cs_per_sec_std / iops_1)
    ...
    ret = {
        ...
        'all_cs_per_io': all_cs_per_io,
        'all_cs_per_io_std': all_cs_per_io_std
    }
    return ret
...
draw_inst_io(global_data['all_inst_per_io'], local_data['all_inst_per_io'],
             ...
             local_data['all_inst_per_io_std'], 'inst_per_io_d7_qds.pdf')
...
draw_branch_miss(global_data['all_branch_miss_rate'],
                 ...
                 local_data['all_branch_miss_rate_std'], 'branch_d7_qds.pdf')
draw_cs_per_sec_io(global_data['all_cs_per_io'], local_data['all_cs_per_io'],
                   global_data['all_cs_per_io_std'],
                   local_data['all_cs_per_io_std'], 'cs_per_io_d7_qds.pdf')
draw_cache_miss(global_data['all_cache_miss_r'],
                local_data['all_cache_miss_r'],
                global_data['all_cache_miss_r_std'],
                local_data['all_cache_miss_r_std'], 'cache_miss_d7_qds.pdf')

print(global_data['all_cs_per_io_std'])
