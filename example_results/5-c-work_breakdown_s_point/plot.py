...
engines = ["aio_s", "iou_s", "iou_c_s", "iou_s_s"]  #, "spdk_fio_s"]
result_path = 'perf_report_instructions'
...
for key, v in enumerate(data):
    unclassified = 100 - np.sum(v)
    v.append(unclassified)

# SPDK
data.append([73, 0, 0, 27, 0, 0])

labels = ["aio", "iou", "iou-c", "iou-s", "spdk-fio"]
bar_names = ['app', 'interface', 'block', 'driver', 'sys', 'misc.']
