...
def remove_symbol(overhead_tree, symbol):
    """" WARNING: THIS WILL CHANGE THE ARGUMENT overhead_tree
...
def parse_report_file(filename):
    classification = {
        ...
        'interface': [
            'io_submit_sqes', 'blkdev_read_iter', 'rw_verify_area',
            'io_do_iopoll', 'io_submit_one', 'io_getevents', 'do_io_getevents'
        ],
        'block': [
