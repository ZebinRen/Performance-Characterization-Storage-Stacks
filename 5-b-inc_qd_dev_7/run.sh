...
DEVICES="/dev/nvme0n1:/dev/nvme1n1:/dev/nvme2n1:/dev/nvme3n1:/dev/nvme4n1:/dev/nvme6n1:/dev/nvme7n1:/dev/nvme8n1"
...
LD_PRELOAD=$SPDK_FIO_PLUGIN fio --iodepth=${q} --filename="trtype=PCIe traddr=0000.65.00.0 ns=1:traddr=0000.68.00.0 ns=1:traddr=0000.67.00.0 ns=1:traddr=0000.66.00.0 ns=1:traddr=0000.19.00.0 ns=1:traddr=0000.1a.00.0 ns=1:traddr=0000.17.00.0 ns=1:traddr=0000.18.00.0 ns=1" ${FIO_OPTIONS_SPDK} -o $RESULTS/spdk_fio_qd_${q}.txt
done
